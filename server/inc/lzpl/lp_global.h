...
template<class T> inline DECLARE void LPAPI lpSwap(T& a, T& b)
{
    T t = a;
    a = b;
    b = t;
...
template<class T> inline DECLARE T LPAPI lpMin(T a, T b)
{
    return a < b ? a : b;
}
...
template<class T> inline DECLARE T LPAPI lpMax(T a, T b)
{
    return a > b ? a : b;
}
...
template<class T> inline DECLARE T LPAPI lpAbs(T a)
{
    return a < 0 ? -a : a;
}
...
template<class T> inline DECLARE T LPAPI lpSqr(T a)
{
    return a * a;
}
...
inline DECLARE float LPAPI lpSqrt(float x)
{
    return sqrtf(x);
}
...
template<class T> inline DECLARE T LPAPI lpClamp(T v, T _min, T _max)
{
