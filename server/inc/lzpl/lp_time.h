...
public:
    ...
    inline LPUINT32 LPAPI GetYear()
    {
        return m_Year;
    }
    inline LPUINT32 LPAPI GetMon()
    {
        return m_Mon;
    }
    inline LPUINT32 LPAPI GetMday()
    {
        return m_Mday;
    }
    inline LPUINT32 LPAPI GetHour()
    {
        return m_Hour;
    }
    inline LPUINT32 LPAPI GetMin()
    {
        return m_Min;
    }
    inline LPUINT32 LPAPI GetSec()
    {
        return m_Sec;
    }
    inline LPUINT32 LPAPI GetMsec()
    {
        return m_Msec;
    }
    inline LPUINT32 LPAPI GetUsec()
    {
        return (LPUINT32)m_stTimeval.m_qwUsec;
    }
    inline LPUINT64 LPAPI GetTimestamp()
    {
        return m_stTimeval.m_qwSec;
    }
