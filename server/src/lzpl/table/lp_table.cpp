...
void LPAPI LPTable::Clear()
{
    ...
    {
        if(m_poTableMap[i].PIntMap != nullptr)
        {
            m_poTableMap[i].PIntMap->clear();
        }
        if(m_poTableMap[i].PStrMap != nullptr)
        {
            m_poTableMap[i].PStrMap->clear();
        }
        if(m_poTableMap[i].PIntMulmap != nullptr)
        {
            m_poTableMap[i].PIntMulmap->clear();
        }
        if(m_poTableMap[i].PStrMulmap != nullptr)
        {
            m_poTableMap[i].PStrMulmap->clear();
        }
    }
